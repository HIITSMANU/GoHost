function validate(e) {
    ...
    if(!gender){
        document.querySelector("#genderError").innerHTML = "Please enter your gender";
        error = true;
    } else {
    ...
    if(mobile === '' || mobile === null){
        ...
        document.querySelector("#mobileError").innerHTML = "Please enter a 10 digit mobile number";
        error = true;
    } else {
    ...
    if (!agree.checked) {
        document.querySelector("#agreeError").innerHTML = "Please agree to the terms and policy";
        error = true;
    } else {
        document.querySelector("#agreeError").innerHTML = "";
    }
    ...
    if (address === '' || address === null) {
        ...
        document.querySelector("#addressError").innerHTML = "please enter valid password";
     }   
     else {
